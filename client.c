...
int main(int argc, char **argv){
    ...
    sem_t *server = sem_open(SEM_SERVER_READY, O_CREAT, PERMISSION, 0);
    ...
    shm_unlink(SEM_PATH);
    sem_unlink(SEM_CLIENT_READY); //Entferne link
    sem_unlink(SEM_SERVER_READY); //Entferne link
